...
class FlareSolverrBypassPlugin : FeaturePlugin {
    ...
    override val manifest = PluginManifest(
        id = "io.github.ireaderorg.plugins.flaresolverr-bypass-linux",
        name = "FlareSolverr Bypass (Linux)",
        version = "1.0.0",
        versionCode = 1,
        description = "Cloudflare bypass using bundled FlareSolverr for Linux.",
    ...
    override fun initialize(context: PluginContext) {
        ...
        println("[FlareSolverr-Linux] Plugin initialized")
    }
    ...
    private val platformDir = "linux-x64"
    private val executableName = "flaresolverr"
    ...
    private fun startServer() {
        ...
        try {
            ...
            println("[FlareSolverr-Linux] Starting: ${executable.absolutePath}")
            ...
            println("[FlareSolverr-Linux] Failed to start: ${e.message}")
        }
    }
    ...
    private fun getPluginDataDir(): java.io.File? {
        val dir = java.io.File(System.getProperty("user.home"), ".local/share/ireader/plugins/flaresolverr")
        dir.mkdirs()
        return dir
    }
}
